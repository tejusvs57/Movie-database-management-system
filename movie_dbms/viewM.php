...
if ($result->num_rows > 0) {
	...
	//	echo"<tr><td>".$row["Movie_id"]."</td><td>".$row["Title"]."</td><td>".$row["Year"]."</td><td>".$row["Company"]."</td><td>".$row["Rating"]."</td><td>".$row["img"]."</td></tr>";
	...
	</td><td>$row[Year]</td><td>$row[Company]</td><td>$row[Rating]</td>
